...
import { LinkedinIcon, TwitterIcon, GithubIcon, SunIcon } from '../Icons.js';
    ...
    return (
        <header className="w-full p-4  px-5 sm:px-10 flex items-center justify-between">
            ...
            <div>
                ...
                <a href="#" className="inline-block w-6 h-6 mr-4"><GithubIcon className="hover:scale-125 transition-all ease duration-200"/></a>
            </div>
        </header>
    )
};
